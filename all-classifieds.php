		...
		<div class="container">
			<div class="select-box">
				<div class="select-city-for-local-ads ads-list">
					<label>Yerel reklamları görmek için şehri seçiniz</label>
						<select>
				...
				<div class="search-product ads-list">
					<label>Belirli bir ürün arayın</label>
					<div class="search">
						<div id="custom-search-input">
						<div class="input-group">
							<input type="text" class="form-control input-lg" placeholder="Telefon" />
			...
			<div class="ads-grid">
				<div class="side-bar col-md-3">
					...
					<h3 class="sear-head">Arama yapın</h3>
					<form>
				...
				<div class="range">
					<h3 class="sear-head">Fiyat aralığı</h3>
				...
				<div class="featured-ads">
					<h2 class="sear-head fer">Öne çıkan İlanlar</h2>
					  ...
					  <ul id="myTab" class="nav nav-tabs nav-tabs-responsive" role="tablist">
						<li role="presentation" class="active">
						  <a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
							<span class="text">Tüm İlanlar</span>
						  </a>
						</li>
						<li role="presentation" class="next">
						  <a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile">
							<span class="text">Fotoğraflı İlanlar</span>
						  </a>
						</li>
						</ul>
								...
								<div class="sort">
								   <div class="sort-by">
										...
										<select>
														...
														<option value="">En düşükten yükseğe</option>
														<option value="">Enyüksekten düşüğe</option>
										</select>
									   </div>
									 </div>
								<div class="clearfix"></div>
